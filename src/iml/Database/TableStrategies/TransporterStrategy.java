 ...
 * @author somesh
 */
public class TransporterStrategy implements ITableStrategy
{
    private final int NumberOfColumns = 4;
    private final EventLogger _eventLogger;
    private final TableNames TableName = TableNames.Transporter;

    public TransporterStrategy()
    {
    ...
    public Object[] GetObjectArrayFromJSONArray(JSONArray jsonArray)
    {
        ...
        {
            ExitProgram.ExitProgramWith("TransporterStrategy", "Count mismatch in GetObjectArrayFromJSONArray. Expected: " + NumberOfColumns + " but was " + jsonArray.size(), null);
        }
