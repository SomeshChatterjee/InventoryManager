 ...
 * @author somesh
 */
public class MOCQualityStrategy implements ITableStrategy
{
    private final int NumberOfColumns = 3;
    private final EventLogger _eventLogger;
    private final TableNames TableName = TableNames.MOCAndQualityCode;

    public MOCQualityStrategy()
    {
    ...
    public String CreateTableQuery()
    {
        ...
        query.append(ColumnNames.MOC).append(" TEXT NOT NULL, ");
        query.append(ColumnNames.QualityCode).append(" TEXT NOT NULL ");
        query.append(" ); ");
    ...
    public String CreateRecordQuery(Object[] values)
    {
        ...
        else
        {
            ...
            query.append(" (");
            query.append(ColumnNames.MOC).append(", ");
            query.append(ColumnNames.QualityCode).append(" ");
            query.append(")");            
            query.append(" VALUES (");
    ...
    public String UpdateQuery(int id, Object[] values)
    {
        ...
        else
        {
            ...
            query.append(" SET ");
            query.append(ColumnNames.MOC).append(" = '").append(values[1]).append("', ");
            query.append(ColumnNames.QualityCode).append(" = '").append(values[2]).append("' ");
    ...
    public Object[][] GetValuesFromResultSet(ResultSet resultSet)
    {
        ...
        {   
            while(resultSet.next())
            {
                ...
                currentRow[1] = resultSet.getString(ColumnNames.MOC.toString());
                currentRow[2] = resultSet.getString(ColumnNames.QualityCode.toString());
